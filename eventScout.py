...
# Data as of December 22

file = 'speedway.xlsx'
df = pd.read_excel(f'./eventData/{file}')

# event_id = 51487  # Hollywood
# event_id = 51483 # Speedway
...
i = 1
desiredInfo = ['teamNumber', 'tsRanking', 'awpPerMatch', 'scoreDriverMax', 'scoreAutoMax', 'scoreTotalMax']
